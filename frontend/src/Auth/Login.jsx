    ...
    <div className="flex min-h-screen w-full bg-red-50">
      ...
      <div className="hidden lg:flex w-1/2 items-center justify-center bg-red-900 relative overflow-hidden">
        ...
        <div className="z-20 text-white text-center px-12 animate-fade-in-down">
          ...
          <div className="mb-6">
            <h1 className="text-5xl font-extrabold tracking-tight animate-pulse">
              Destiny Angas <br/> Monitoring System
            </h1>
          </div>
          <p className="text-xl text-red-100 font-light tracking-wide">
             Chicken Monitoring & Tracking
          </p>
        </div>
      </div>
      ...
      <div className="flex w-full lg:w-1/2 flex-col justify-center px-8 md:px-16 lg:px-24 bg-white">
        ...
        <div className="w-full max-w-md mx-auto animate-slide-up">
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="group">
              <label className="block text-sm font-medium text-gray-700 mb-2 transition-colors group-hover:text-red-700">Username</label>
              <input 
                type="text" 
            ...
            <div className="group">
              <label className="block text-sm font-medium text-gray-700 mb-2 transition-colors group-hover:text-red-700">Password</label>
              <input 
                type="password" 
                placeholder="••••••••" 
                className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:border-red-600 focus:bg-white focus:ring-4 focus:ring-red-100 transition-all duration-300 outline-none" 
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm font-bold text-red-700 hover:text-red-900 transition-colors">Forgot password?</a>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-600">
            No account yet? <Link to="/signup" className="font-bold text-red-700 hover:text-red-900 underline transition-colors">Create one here</Link>
          </p>
        </div>
      </div>
